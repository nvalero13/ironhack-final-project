<template>
    <div
        ...
        <div class="p-4 w-full min-w-[200px]">
            ...
            <input v-model="title" maxlength="20" class="h-12 w-full block outline-none border-b dark:text-white dark:bg-slate-700"
