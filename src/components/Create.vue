<template>
  <Transition name="bounce">
        <div v-if="taskStore.creating === true" class="p-2 m-10 border bg-white dark:bg-slate-700 relative">
            <h1 class="p-2 text-lg mb-2 pb-2 border-b dark:text-white">✏️ Create new task</h1>
   
            <input v-model="title" class="p-2 block w-10/12 dark:text-white dark:bg-slate-700" name="Title" type="text" placeholder="Title">
