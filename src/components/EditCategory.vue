    ...
    <div class="bg-white dark:bg-slate-700 border absolute left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 pb-6">
        ...
        <div class="absolute right-1/2 translate-x-1/2 -bottom-5 flex gap-2">
            <button @click="editCategory" :disabled="isDisabled"
                class="border rounded-full h-10 px-4 w-28 bg-emerald-500 shadow-md text-white enabled:hover:scale-105 enabled:hover:bg-emerald-600 disabled:bg-gray-200 dark:disabled:bg-slate-700 transition-all">
                <i class="fa-solid fa-pencil"></i>
                Apply
            </button>
            <button @click="deleteCategory"
                class="border rounded-full h-10 px-4 w-28 bg-red-500 shadow-md text-white enabled:hover:scale-105 enabled:hover:bg-red-600 disabled:bg-gray-200 dark:disabled:bg-slate-700 transition-all">
...
const colors = ref([{ bg: "bg-rose-500" }, { bg: "bg-red-500" }, { bg: "bg-orange-500" }, { bg: "bg-yellow-500" }, { bg: "bg-lime-500" }, { bg: "bg-green-500" }, { bg: "bg-emerald-500" }, { bg: "bg-teal-500" }, { bg: "bg-blue-500" }, { bg: "bg-violet-500" },]);
